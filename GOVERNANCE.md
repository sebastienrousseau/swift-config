...
This document describes how @sebastienrousseau/swift-config is run: who decides what, how
...
@sebastienrousseau/swift-config is **maintainer-led**. As of the current release line it has a single
