...
# Packaging @sebastienrousseau/swift-config
...
-  `.swiftlint.yml`, `.swiftformat` — the tool-native preset file(s)
...
| :----- | :--- | :---------- |
| Debian | [`pkg/deb/`](../pkg/deb) | `/usr/share/nodejs/@sebastienrousseau/swift-config/` |
| RPM | [`pkg/rpm/`](../pkg/rpm) | `/usr/lib/node_modules/@sebastienrousseau/swift-config/` |
| Arch | [`pkg/aur/PKGBUILD`](../pkg/aur/PKGBUILD) | `/usr/lib/node_modules/@sebastienrousseau/swift-config/` |
| Homebrew | [`pkg/brew/swift-config.rb`](../pkg/brew/swift-config.rb) | formula cellar |
| Nix | [`pkg/nix/flake.nix`](../pkg/nix/flake.nix) | `$out/lib/node_modules/@sebastienrousseau/swift-config/` |
